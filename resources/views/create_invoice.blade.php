    ...
    <form id="add-form" class="form-horizontal form-center" action="/sk/invoice/store" method="post">
        <fieldset>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input class="form-control" id="items" placeholder="Items" type="text">
                </div>
            </div>
            <div class="form-group">
                <label for="price" class="col-lg-2 control-label">Price</label>
                <div class="col-sm-6">
                    <input class="form-control" id="price" placeholder="Price" type="text">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input class="form-control" id="date_of_invoicing" placeholder="Date of invoicing" type="date">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input class="form-control" id="code" placeholder="Code" type="text">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input class="form-control" id="street" placeholder="Street" type="text">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input class="form-control" id="zip" placeholder="ZIP" type="text">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input class="form-control" id="ico" placeholder="ICO" type="text">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input class="form-control" id="dic" placeholder="DIC" type="text">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input class="form-control" id="dic-dph" placeholder="DIC DPH" type="text">
                </div>
            </div>
